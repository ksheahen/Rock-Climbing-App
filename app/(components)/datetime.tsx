...
export default function DateTimeComponent({ initial, onChange }: Props) {
        ...
        <View style={styles.modalBackdrop}>
          <View style={styles.modalCard}>
            ...
            <FlatList
              ...
              renderItem={({ item }) => {
                ...
                return (
                  ...
                  >
                    <Text style={[styles.timeRowText, isActive && styles.timeRowTextActive]}>
                      {item.label}
                    </Text>
                  </Pressable>
                );
            ...
            <View style={styles.modalActions}>
              <Pressable onPress={() => setShowModal(false)} style={styles.modalActionBtn}>
