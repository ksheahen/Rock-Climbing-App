...
describe("UserAchievement Service Tests", () => {
  ...
  afterAll(async () => {
    if (testUserAchievementId) {
      await deleteUserAchievement(
        testUserAchievementId.user_id,
        testUserAchievementId.achievement_id,
      );
    }
  ...
  it("should fetch achievements by user", async () => {
    ...
    const found = achievements.find(
      (a) => a.achievement_id === testAchievementId,
    );
  ...
  it("should update the user achievement", async () => {
    ...
    const updated = await updateUserAchievement(testUserId, testAchievementId, {
      earned_date: newDate,
    });
