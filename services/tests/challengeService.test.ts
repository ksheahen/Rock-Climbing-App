...
import { createChallenge, deleteChallenge, getChallengeById, updateChallenge } from '../challengeService';
...
describe('Challenge Service Tests', () => {
  ...
  it('should update the challenge', async () => {
    ...
    const updatedChallenge = await updateChallenge(testChallengeId, { title: updatedTitle });
